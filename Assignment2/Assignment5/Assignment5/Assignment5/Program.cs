...
namespace Assignment5
{
    ...
    public class Bank
    {
        ...
        public Bank()
        {
            ...
            Console.WriteLine($"The Account details is : Account Num {Acc_Number}, Account Name {Acc_Name}, Amount is {Amount}");
           ...
           public void DepositeAmount()
        {
            ...
            if (DepAmount == 0)
            {
                Console.WriteLine("Deposite the minimum amount above 5000.00 ");
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Enter  numbers only ", fe);
            }
            Console.Read();
        }
    }
